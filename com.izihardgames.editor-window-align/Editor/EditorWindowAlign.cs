...
using IziHardGames.ForUnityEditor;
...
namespace IziHardGames.CustomEditor.Window
{
    public class EditorWindowAlign : EditorWindow
    {
        ...
        [MenuItem(ConstantsForUnityEditor.MENU_CATEGORY_NAME + ConstantsForUnityEditor.SEPARATOR + "Windows/2D/AlignTool")]
        static void Init()
        {
        ...
        private void OnGUI()
        {
            ...
            switch (eAlignType)
            {
                ...
                case EAlignType.Vector2:
                    ...
                    vector2 = EditorLayoutCustom.Vector2Field("Vector2:", vector2);
                    break;
                case EAlignType.Vector3:
                    //vector3 = EditorGUILayout.Vector3Field("Vector3:", vector3);
                    vector3 = EditorLayoutCustom.Vector3Field("Vector3:", vector3);
                    break;
